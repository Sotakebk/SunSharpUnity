...
{
    internal class EditorLibrary : ISunVoxLib
    {
        private static EditorLibrary _instance;
        ...
        internal static ISunVoxLib Instance => _instance;

        internal static EditorLibrary WrapperInstance => _instance;

        private EditorLibrary()
        {
        }

        static EditorLibrary()
        {
            _instance = new EditorLibrary();
        }
